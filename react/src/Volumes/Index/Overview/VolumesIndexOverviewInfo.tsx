...
import VolumesIndexOverviewInfoRow from './VolumesIndexOverviewInfoRow';
import styles from './VolumesIndexOverviewInfo.module.css';
...
interface VolumesIndexOverviewInfoProps {
    height: number;
    showNetwork: boolean;
...
const infoRowHeight = parseInt(dimensions.volumesIndexOverviewInfoRowHeight);
...
export default VolumesIndexOverviewInfo;
