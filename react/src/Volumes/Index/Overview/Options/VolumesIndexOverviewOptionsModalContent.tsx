...
interface VolumesIndexOverviewOptionsModalContentProps {
    onModalClose(...args: unknown[]): void;
}

function VolumesIndexOverviewOptionsModalContent(
    props: VolumesIndexOverviewOptionsModalContentProps,
) {
    ...
    const onOverviewOptionChange = useCallback(
        ...
        ({ name, value }: { name: string; value: unknown }) => {
            // dispatch(setVolumesOverviewOption({ [name]: value }));
        },
        [dispatch],
    );
...
export default VolumesIndexOverviewOptionsModalContent;
