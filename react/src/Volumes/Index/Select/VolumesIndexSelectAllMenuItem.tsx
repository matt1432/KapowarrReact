...
interface VolumesIndexSelectAllMenuItemProps {
    label: string;
    isSelectMode: boolean;
}

function VolumesIndexSelectAllMenuItem(props: VolumesIndexSelectAllMenuItemProps) {
...
export default VolumesIndexSelectAllMenuItem;
