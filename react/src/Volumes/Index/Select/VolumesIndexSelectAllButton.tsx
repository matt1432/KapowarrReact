...
interface VolumesIndexSelectAllButtonProps extends Omit<PageToolbarButtonProps, 'iconName'> {
    isSelectMode: boolean;
}

function VolumesIndexSelectAllButton(props: VolumesIndexSelectAllButtonProps) {
...
export default VolumesIndexSelectAllButton;
