...
interface VolumesIndexSelectModeButtonProps extends PageToolbarButtonProps {
    isSelectMode: boolean;
    onPress: () => void;
}

function VolumesIndexSelectModeButton(props: VolumesIndexSelectModeButtonProps) {
...
export default VolumesIndexSelectModeButton;
