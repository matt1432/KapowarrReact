import VolumesImage, { type VolumesImageProps } from './VolumesImage';
...
interface VolumesBannerProps extends Omit<VolumesImageProps, 'coverType' | 'placeholder'> {
    size?: 35 | 70;
}

function VolumesBanner({ size = 70, ...otherProps }: VolumesBannerProps) {
    return (
        <VolumesImage
            {...otherProps}
            size={size}
