...
export const FINALE_COMICS = fasCircleStop;
...
export const COMICS_CONTINUING = fasPlay;
export const COMICS_ENDED = fasStop;
export const COMICS_DELETED = fasExclamationTriangle;
