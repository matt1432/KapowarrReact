...
export default function TimeLeftCell({ size, sizeLeft, status, timeLeft }: TimeLeftCellProps) {
    ...
    return (
        <TableRowCell className={styles.timeLeft} title={`${remainingSize} / ${totalSize}`}>
