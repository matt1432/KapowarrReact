...
import styles from './ImportComicsSelectFolder.module.css';

function ImportComicsSelectFolder() {
                ...
                {!error && isPopulated && (
                    <div>
                        <div className={styles.header}>
                            {translate('LibraryImportComicsHeader')}
                        </div>
                        ...
                        <div className={styles.tips}>
                            ...
                            <ul>
                                ...
                                <li className={styles.tip}>
                                    <InlineMarkdown
                                        data={translate('LibraryImportTipsComicsUseRootFolder', {
                                            goodFolderExample,
                                            badFolderExample,
                                        })}
                                    />
...
export default ImportComicsSelectFolder;
