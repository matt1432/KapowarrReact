...
import selectPosterOptions from 'Comics/Index/Posters/selectPosterOptions';
// import { setComicsPosterOption } from 'Store/Actions/comicsIndexActions';
...
interface ComicsIndexPosterOptionsModalContentProps {
    onModalClose(...args: unknown[]): unknown;
}

function ComicsIndexPosterOptionsModalContent(props: ComicsIndexPosterOptionsModalContentProps) {
    ...
    const onPosterOptionChange = useCallback(
        ...
        ({ name, value }: { name: string; value: unknown }) => {
            // dispatch(setComicsPosterOption({ [name]: value }));
        },
        [dispatch],
    );
                ...
                <Form>
                    ...
                    <FormGroup>
                        ...
                        <FormInputGroup
                            ...
                            name="showTitle"
                            value={showTitle}
                            helpText={translate('ShowComicsTitleHelpText')}
                            onChange={onPosterOptionChange}
                        />
                    </FormGroup>
...
export default ComicsIndexPosterOptionsModalContent;
