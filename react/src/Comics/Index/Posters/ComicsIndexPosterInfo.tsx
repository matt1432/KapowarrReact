...
import styles from './ComicsIndexPosterInfo.module.css';

interface ComicsIndexPosterInfoProps {
...
function ComicsIndexPosterInfo(props: ComicsIndexPosterInfoProps) {
    const {
        originalLanguage,
        network,
        qualityProfile,
    ...
    if (sortKey === 'added' && added) {
        ...
        return (
            <div className={styles.info} title={formatDateTime(added, longDateFormat, timeFormat)}>
...
export default ComicsIndexPosterInfo;
