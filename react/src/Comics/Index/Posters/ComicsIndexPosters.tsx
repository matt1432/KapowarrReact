...
import ComicsIndexPoster from 'Comics/Index/Posters/ComicsIndexPoster';
...
interface ComicsIndexPostersProps {
    items: Comics[];
    sortKey: string;
...
const comicsIndexSelector = createSelector(
...
export default function ComicsIndexPosters(props: ComicsIndexPostersProps) {
    const { scrollerRef, items, sortKey, jumpToCharacter, isSelectMode, isSmallScreen } = props;

    const { posterOptions } = useSelector(comicsIndexSelector);
