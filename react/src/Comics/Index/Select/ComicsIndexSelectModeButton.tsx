...
interface ComicsIndexSelectModeButtonProps extends PageToolbarButtonProps {
    isSelectMode: boolean;
    onPress: () => void;
}

function ComicsIndexSelectModeButton(props: ComicsIndexSelectModeButtonProps) {
...
export default ComicsIndexSelectModeButton;
