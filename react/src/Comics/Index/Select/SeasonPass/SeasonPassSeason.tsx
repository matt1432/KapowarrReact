...
// import { toggleSeasonMonitored } from 'Store/Actions/comicsActions';
...
function SeasonPassSeason(props: SeasonPassSeasonProps) {
    ...
    const onSeasonMonitoredPress = useCallback(() => {
        // dispatch(toggleSeasonMonitored({ comicsId, seasonNumber, monitored: !monitored }));
    }, [comicsId, seasonNumber, monitored, dispatch]);
