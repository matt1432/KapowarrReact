...
interface ComicsIndexSelectModeMenuItemProps {
    label: string;
    iconName: IconName;
...
function ComicsIndexSelectModeMenuItem(props: ComicsIndexSelectModeMenuItemProps) {
...
export default ComicsIndexSelectModeMenuItem;
