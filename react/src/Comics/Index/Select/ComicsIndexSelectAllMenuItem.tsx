...
interface ComicsIndexSelectAllMenuItemProps {
    label: string;
    isSelectMode: boolean;
}

function ComicsIndexSelectAllMenuItem(props: ComicsIndexSelectAllMenuItemProps) {
...
export default ComicsIndexSelectAllMenuItem;
