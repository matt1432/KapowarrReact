...
interface ComicsIndexSelectAllButtonProps extends Omit<PageToolbarButtonProps, 'iconName'> {
    isSelectMode: boolean;
}

function ComicsIndexSelectAllButton(props: ComicsIndexSelectAllButtonProps) {
...
export default ComicsIndexSelectAllButton;
