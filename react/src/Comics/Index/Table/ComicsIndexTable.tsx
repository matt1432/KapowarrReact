...
import ComicsIndexRow from './ComicsIndexRow';
import ComicsIndexTableHeader from './ComicsIndexTableHeader';
import styles from './ComicsIndexTable.module.css';
...
interface ComicsIndexTableProps {
    items: Comics[];
    sortKey: string;
...
const columnsSelector = createSelector(
    (state: AppState) => state.comicsIndex.columns,
    (columns) => columns,
);
...
function ComicsIndexTable(props: ComicsIndexTableProps) {
    const {
        items,
        sortKey,
        sortDirection,
...
export default ComicsIndexTable;
