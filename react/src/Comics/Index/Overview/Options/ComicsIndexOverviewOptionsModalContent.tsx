...
// import { setComicsOverviewOption } from 'Store/Actions/comicsIndexActions';
...
interface ComicsIndexOverviewOptionsModalContentProps {
    onModalClose(...args: unknown[]): void;
}

function ComicsIndexOverviewOptionsModalContent(
    props: ComicsIndexOverviewOptionsModalContentProps,
) {
    ...
    const onOverviewOptionChange = useCallback(
        ...
        ({ name, value }: { name: string; value: unknown }) => {
            // dispatch(setComicsOverviewOption({ [name]: value }));
        },
        [dispatch],
    );
...
export default ComicsIndexOverviewOptionsModalContent;
