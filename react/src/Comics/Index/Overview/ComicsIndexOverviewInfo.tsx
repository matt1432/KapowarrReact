...
import ComicsIndexOverviewInfoRow from './ComicsIndexOverviewInfoRow';
import styles from './ComicsIndexOverviewInfo.module.css';
...
interface ComicsIndexOverviewInfoProps {
    height: number;
    showNetwork: boolean;
...
const infoRowHeight = parseInt(dimensions.comicsIndexOverviewInfoRowHeight);
...
function getInfoRowProps(
    row: RowProps,
    props: ComicsIndexOverviewInfoProps,
...
function ComicsIndexOverviewInfo(props: ComicsIndexOverviewInfoProps) {
    ...
    return (
        <div className={styles.infos}>
            ...
            {rowInfo.map((row) => {
                ...
                return <ComicsIndexOverviewInfoRow key={row.name} {...infoRowProps} />;
            })}
        </div>
    );
}

export default ComicsIndexOverviewInfo;
