...
import ComicsIndexOverview from './ComicsIndexOverview';
...
interface ComicsIndexOverviewsProps {
    items: Comics[];
    sortKey: string;
...
function Row({ index, style, data }: ListChildComponentProps<RowItemData>) {
    ...
    return (
        <div style={style}>
            <ComicsIndexOverview comicsId={comics.id} {...otherData} />
        </div>
    );
}
...
function ComicsIndexOverviews(props: ComicsIndexOverviewsProps) {
...
export default ComicsIndexOverviews;
