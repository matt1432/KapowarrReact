import ComicsImage, { type ComicsImageProps } from './ComicsImage';
...
interface ComicsBannerProps extends Omit<ComicsImageProps, 'coverType' | 'placeholder'> {
    size?: 35 | 70;
}

function ComicsBanner({ size = 70, ...otherProps }: ComicsBannerProps) {
    return (
        <ComicsImage
            {...otherProps}
            size={size}
