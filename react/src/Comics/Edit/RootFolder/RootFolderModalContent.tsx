...
interface ComicsFolder {
    folder: string;
}

function RootFolderModalContent(props: RootFolderModalContentProps) {
    const { comicsId, onSavePress, onModalClose } = props;
    ...
    const { isLoading, data } = useApiQuery<ComicsFolder>({
        path: `/comics/${comicsId}/folder`,
    });
    ...
    return (
        <ModalContent onModalClose={onModalClose}>
            <ModalHeader>{translate('UpdateComicsPath')}</ModalHeader>
