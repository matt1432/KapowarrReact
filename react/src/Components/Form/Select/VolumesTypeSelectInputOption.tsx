...
import styles from './VolumesTypeSelectInputOption.module.css';

interface VolumesTypeSelectInputOptionProps extends EnhancedSelectInputOptionProps {
    id: string;
    value: string;
    format: string;
    isMobile: boolean;
...
function VolumesTypeSelectInputOption(props: VolumesTypeSelectInputOptionProps) {
...
export default VolumesTypeSelectInputOption;
