...
import styles from './ComicsTypeSelectInputOption.module.css';

interface ComicsTypeSelectInputOptionProps extends EnhancedSelectInputOptionProps {
    id: string;
    value: string;
    format: string;
    isMobile: boolean;
...
function ComicsTypeSelectInputOption(props: ComicsTypeSelectInputOptionProps) {
...
export default ComicsTypeSelectInputOption;
