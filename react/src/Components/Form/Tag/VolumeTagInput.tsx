...
export interface VolumeTagInputProps<V> {
    name: string;
    value: V;
...
/*
function createVolumeTagsSelector(tags: number[]) {
    return createSelector(createTagsSelector(), (tagList) => {
        ...
        return {
            tags: tags.reduce((acc: VolumeTag[], tag) => {
...
export default function VolumeTagInput<V extends number | number[]>({
        // name,
        // value,
        // onChange,
    ...
    // const { tags, tagList, allTags } = useSelector(createVolumeTagsSelector(arrayValue));
