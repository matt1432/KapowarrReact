...
import type { DateFilterBuilderTime, DateFilterValue, FilterType } from 'Helpers/Props/filterTypes';
import type { InputChanged, InputOnChange } from 'typings/inputs';
import isString from 'Utilities/String/isString';
import { type FilterBuilderRowValueProps, NAME } from './FilterBuilderRowValue';
...
interface DateFilterBuilderRowValueProps<T>
    extends Omit<FilterBuilderRowValueProps<T, string>, 'filterValue' | 'onChange'> {
