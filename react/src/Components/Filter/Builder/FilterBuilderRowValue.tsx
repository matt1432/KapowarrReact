...
export interface FilterBuilderTag<V extends string | number | boolean> extends TagBase {
    id: V;
    name: string | number;
}

export interface FilterBuilderRowValueProps<T, V extends string | number | boolean> {
