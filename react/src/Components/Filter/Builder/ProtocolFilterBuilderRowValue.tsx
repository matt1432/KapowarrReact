...
type ProtocolFilterBuilderRowValueProps<T> = Omit<FilterBuilderRowValueProps<T, string>, 'tagList'>;

function ProtocolFilterBuilderRowValue<T>(props: ProtocolFilterBuilderRowValueProps<T>) {
