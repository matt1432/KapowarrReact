                ...
                <>
                    <ModalBody>
                        <p>
                            ...
                            downloads for the volumes in your library. The
                            comics can be downloaded via multiple services.
                            Kapowarr has built-in support for almost all these
                            services.
                            <br />
                            <br />
                            When downloading directly from the servers of
                            GetComics (instead of using an external service),
                            the download speed will be significantly reduced
                            400MB into the download. This behaviour is set up by
                            the owner of the website, is intentional, and is not
                            planned to be removed.
                            <br />
                            <br />
                            Also, most often on Wednesday and Thursday, the site
                            is very busy so the downloads speed goes down a lot.
