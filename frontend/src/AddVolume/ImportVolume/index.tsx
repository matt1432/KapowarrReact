...
export default function ImportVolume() {
    const [getProposals, { data, isFetching, error }] =
            ...
            <PageContentBody>
                ...
                {!onResultsPage && !isFetching ? (
                    <FieldSet legend="Import an existing organized library to add volumes to Kapowarr">
                        ...
                        <ul>
                            <li>
                                Check if Kapowarr matched correctly! Comicvine
                                has separate releases for normal volumes, TPB's,
                                one shots, hard covers, etc. So even though the
                                name and year match, it could still be a wrong
                                match.
                            </li>
                            <li>
                                Importing a lot of volumes in one go will
                                quickly make Kapowarr reach the rate limit of
                                ComicVine. Import volumes in batches to avoid
                                this. It's advised to not go above 50 volumes at
                                a time.
                            </li>
                            <li>
                                Files are not allowed to be directly in the root
                                folder. They have to be in a sub-folder.
                            </li>
                        </ul>
