...
def set_volume_folder_permissions(
    volume_folder: str, root_folder: str, folder_permissions: str
) -> None:
    ...
    file_permissions = "".join(
        str(int(p) - 1) if int(p) % 2 == 1 else p for p in folder_permissions
    )
...
def set_volume_folder_owner_group(
    volume_folder: str, root_folder: str, owner_group: str
) -> None:
